  ...
  const renderFloatingNavigation = () => {
    ...
    return (
      <div className="bases-calendar-floating-nav" style={floatingNavStyle}>
        ...
        <button className="bases-calendar-nav-button" onClick={onPrevClick} title="Previous" style={{ pointerEvents: 'auto' }}>&#8249;</button>
        <button className="bases-calendar-nav-button" onClick={onTodayCentered} style={{ fontSize: '0.8rem', padding: '2px 8px', pointerEvents: 'auto' }}>Today</button>
        <button className="bases-calendar-nav-button" onClick={onNextClick} title="Next" style={{ pointerEvents: 'auto' }}>&#8250;</button>
      </div>
    );
  };
