...
export class SettingsManager {
  ...
  sanitizeSettings(raw: unknown): NotebookNavigatorCompanionSettings {
    ...
    return {
      ...
      frontmatterIconField: normalizeFrontmatterField(record.frontmatterIconField, DEFAULT_SETTINGS.frontmatterIconField),
      frontmatterColorField: normalizeFrontmatterField(record.frontmatterColorField, DEFAULT_SETTINGS.frontmatterColorField),
  ...
  private sanitizeSmartSort(rawSort: unknown): SmartSortSettings {
    ...
    return {
      ...
      field: normalizeFrontmatterField(record.field, DEFAULT_SETTINGS.smartSort.field),
