const PLUGIN_PREFIX = "[TPS Auto Base Embed]";
const PLUGIN_NAME = "TPS Auto Base Embed";
...
export function log(message?: unknown, ...rest: unknown[]): void {
...
export function error(message?: unknown, ...rest: unknown[]): void {
  emit("error", message, rest, { allowWhenDisabled: true });
}
