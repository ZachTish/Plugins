...
export const DEFAULT_SETTINGS: TPSGlobalContextMenuSettings = {
  ...
  lineTrackingSurfaceFolders: [],
  lineTrackingHeadingNames: [],
  lineTrackingTreatDailyNotesAsSurface: false,
  lineTrackingPromotionRequiresSurface: true,
  lineTrackingTrackCheckboxes: true,
  lineTrackingTrackBullets: true,
  lineTrackingTrackHeadings: true,
  ...
  taskSurfacePaths: ['Hca Calendar.md', 'Workouts.md'],
