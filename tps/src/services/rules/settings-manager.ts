...
export class SettingsManager {
  ...
  sanitizeSettings(raw: unknown): NotebookNavigatorCompanionSettings {
    ...
    return {
      ...
      writeBasesIconFields: asBoolean(record.writeBasesIconFields, DEFAULT_SETTINGS.writeBasesIconFields),
      basesIconMarkdownField: this.normalizeSafeFrontmatterField(
        record.basesIconMarkdownField,
        DEFAULT_SETTINGS.basesIconMarkdownField
      ),
      basesIconUriField: this.normalizeSafeFrontmatterField(
        record.basesIconUriField,
        DEFAULT_SETTINGS.basesIconUriField
      ),
